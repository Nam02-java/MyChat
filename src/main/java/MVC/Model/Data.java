...
public class Data {
    ...
    public String updateMaxReceivedId(String input) throws InterruptedException {
        synchronized (this) {
            Thread.sleep(5000);
            String threadName = Thread.currentThread().getName();
            System.out.println("Thread " + threadName + " entered synchronized block");
            ...
            System.out.println("Thread " + threadName + " leaving synchronized block");
